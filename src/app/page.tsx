...
export default function Home() {
  ...
  return (
    <div id="home" className={`min-h-screen flex flex-col ${dark ? 'bg-black' : 'bg-white'}`}>
      ...
      <main className="flex flex-col items-center flex-1 pt-16 md:pt-20 pb-20 px-4 md:px-6">
        ...
        <section id="projects" className="w-full max-w-4xl mt-24 md:mt-32 scroll-mt-24">
